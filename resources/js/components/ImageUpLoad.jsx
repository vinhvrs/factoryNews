// resources/js/components/NewsEditor.jsx
import React, { useState, useRef } from 'react'
import axios from 'axios'
import { Form, useNavigate, useParams } from 'react-router-dom'

export default function ImageUpload({ mode = 'create' }) {
  ...
  function insertImage(imgData) {
    ...
    const imgTag = `<img src="${imgPath}" alt="${imgData.imageAlt}" />`
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <label className="inline-block mt-2 px-4 py-2 bg-gray-200 rounded cursor-pointer hover:bg-gray-300">
            📷 {mode === 'create' ? 'Upload Image' : 'Add Image'}
            <input
              type="file"
              accept="image/*"
