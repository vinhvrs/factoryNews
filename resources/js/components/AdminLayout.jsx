            ...
            <nav className="sticky top-0 z-10 space-x-4 max-w-screen mb-6 bg-gray-800 p-4 text-white">
                <div className="container mx-auto flex items-center justify-between space-x-4">
                    <div className="flex space-x-6">
                        <Link to="/admin-panel/dashboard" className="">Dashboard</Link>
                        <Link to="/admin-panel/news-management" className="">News Management</Link>
                        <Link to="/admin-panel/account-management" className="">Account Management</Link>
                    </div>
